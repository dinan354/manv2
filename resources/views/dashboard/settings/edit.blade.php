	...
	<div class="panel panel-inverse">
		...
		<div class="panel-body">
			<ul id="tabs" class="nav nav-tabs" data-tabs="tabs">
		        ...
		        <li><a href="#tabtwo" data-toggle="tab">Insight Info</a></li>
		    </ul>
		    <div id="my-tab-content" class="tab-content">
		        <div class="tab-pane active" id="tabone">
		            <div id="new-banner-form">
		            	<form class="form form-horizontal" method="post" enctype="multipart/form-data" action="{{ url('/settings/banner/update/'.$banner->id) }}">
		            		<input type="hidden" name="_token" value="{{ csrf_token() }}">
		            		<div class="form-group">
		            			<label class="control-label col-md-2">File Banner</label>
		            			<div class="col-md-8">
		            				<img src="{{ $banner->banner }}" class="img-responsive">
		            				<br>
		            		...
		            		<div class="form-group">
		            			...
		            			<div class="col-md-8">
		            				<input value="{{ $banner->banner_title }}" type="text" name="title" required="true" class="form-control">
		            			</div>
		            		</div>
		            		<div class="form-group">
		            			<label class="control-label col-md-2">Text Banner</label>
		            			<div class="col-md-8">
		            				<input value="{{ $banner->banner_text }}" type="text" name="text" required="true" class="form-control">
		            			</div>
		            		</div>
		            		<div class="form-group">
